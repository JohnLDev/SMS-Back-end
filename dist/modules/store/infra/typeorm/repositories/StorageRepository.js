...
var Storage_1 = __importDefault(require("../entities/Storage"));
var StorageRepository = /** @class */ (function () {
    function StorageRepository() {
        this.OrmRepository = typeorm_1.getRepository(Storage_1.default);
    }
    StorageRepository.prototype.create = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        item = this.OrmRepository.create({
                            name: name,
                            brand: brand,
                            price: price,
                            amount: amount,
    ...
    StorageRepository.prototype.update = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.OrmRepository.save(item)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, item];
                }
    ...
    StorageRepository.prototype.findByName = function (name, user_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.OrmRepository.findOne({ where: { user_id: user_id, name: name } })];
                    case 1:
                        item = _a.sent();
                        return [2 /*return*/, item];
                }
    ...
    StorageRepository.prototype.findByBrand = function (brand, user_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.OrmRepository.find({ where: { user_id: user_id, brand: brand } })];
                    case 1:
                        storage = _a.sent();
                        return [2 /*return*/, storage];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.OrmRepository.findOne({
                            where: { user_id: user_id, name: name, brand: brand },
                        })];
                    case 1:
                        item = _a.sent();
                        return [2 /*return*/, item];
    ...
    StorageRepository.prototype.findByBarcode = function (barcode, user_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.OrmRepository.findOne({
                            where: { user_id: user_id, barcode: barcode },
                        })];
                    case 1:
                        item = _a.sent();
                        return [2 /*return*/, item];
