...
var SendRedefinitionPasswordEmail = /** @class */ (function () {
    function SendRedefinitionPasswordEmail(subUserRepository) {
        this.subUserRepository = subUserRepository;
    }
    SendRedefinitionPasswordEmail.prototype.execute = function (email, user_id) {
        return __awaiter(this, void 0, void 0, function () {
            var emailValidation, subUser, _a, secret, expiresIn, token, link, filePath, source, template, replacements, htmlToSend, mailOptions;
