...
var UserRepository = /** @class */ (function () {
    ...
    UserRepository.prototype.findByVerify_Key = function (verify_Key) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    UserRepository.prototype.findAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.ormRepository.find({ relations: ['images'] })];
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, user];
                }
    ...
    UserRepository.prototype.findByEnterprise_Name = function (enterprise_Name) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
