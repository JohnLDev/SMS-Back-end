...
describe('SendRedefinitionPasswordEmail', function () {
    it('should be able to send a recovery email', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUserRepository, createUserService, sendRedefinitionPasswordEmail, user, Email;
    ...
    it('should be not able to send a recovery email to a unregistered email', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUserRepository, sendRedefinitionPasswordEmail, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeUserRepository = new FakeUserRepository_1.default();
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, sendRedefinitionPasswordEmail.execute('email@nãovalido.com')];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
